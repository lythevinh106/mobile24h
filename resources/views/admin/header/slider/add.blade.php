@extends('admin.main')
@section('content')
    <form method="post" action="{{ route('admin.header.store_slider') }}" enctype="multipart/form-data">


        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Tên Slider</label>
        ...
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Chọn Ảnh Slider</label>

...
@section('content')
    ...
    <form method="post" action="{{ url("admin/promotion/update/$promotion->id") }}">


        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Tên Khuyến Mãi</label>
            <input value="{{ $promotion->name }}" type="text" name="name" class="form-control" id="exampleInputEmail1"
        ...
        <div class="mb-3">
            ...
            <input value="{{ $promotion->title }}" type="text" name="title" class="form-control"
        ...
        <div class="mb-3">
            ...
            <input value="{{ $promotion->value }}" type="number" name="value" min="0" id="value_promotion">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="type" id="type_promotion" aria-label="Default select example">
                ...
                <option value="0" {{ $promotion->type == 0 ? 'selected' : '' }}>Khuyến mãi theo % </option>
                <option value="1" {{ $promotion->type == 1 ? 'selected' : '' }}>Khuyến mãi theo giá</option>
            </select>
        </div>
        ...
        <div class="mb-3">
            ...
            <input value="{{ $carbon::parse($promotion->start_date)->format('Y-m-d\TH:i') }}" type="datetime-local"
                name="start_date" class="form-control" aria-describedby="emailHelp">
        ...
        <div class="mb-3">
            ...
            <input value="{{ $carbon::parse($promotion->end_date)->format('Y-m-d\TH:i') }}" type="datetime-local"
                name="end_date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" {{ $promotion->active == 1 ? 'checked' : '' }} name="active"
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="active" {{ $promotion->active == 0 ? 'checked' : '' }}
